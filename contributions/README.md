...
| [dock-cycle](dock-cycle) | Undock, dock, recharge & station services | ![25%](https://img.shields.io/badge/25%25-yellow) | two docks modelled in sim (basic charging pad + auto-empty/mop-wash), manual undocking demoed; dock teardown, schematic, sensors + fans sourced; docking behaviours not started |
...
| [io-pcb](io-pcb) | I/O + motor-driver PCB (KiCad) | ![50%](https://img.shields.io/badge/50%25-yellow) | drive wheels brought up on the bench; schematic with cliff/bumper/wheel connectors, debug UART, M.2, front + side sensor boards, watchdog + motor shutoff, charging dock; main-board placement started; not validated, do not fabricate |
